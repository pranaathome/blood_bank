...
<head>
  ...
  <!-- Date and Time -->
  <script src="../resources/js/date_time.js"></script>
    <!-- JQuery -->
                  ...
                  <div class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/bloodbank/logoutprocess.php">Log Out</a></li>
                      </ul>
                  </div>
              </ul>
          </div>
      ...
      <div class="sidebar-wrapper">
        ...
        <!-- SIDEBAR USER TITLE -->
          ...
          <div class="sidebar-menu" role="menu">
            ...
            <li>
              <a> Konfirmasi Acara </a>
            </li>
            <li>
              <a> Daftar Penyelenggara </a>
            </li>
            <li>
              <a> Daftar Pendonor </a>
            </li>
